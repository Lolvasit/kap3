...
class Setting(BaseModel):
    ...
    capcha_btn_text = TextField(default="Yes", null=True)
    capcha_time = IntegerField(default=30, null=True)

    migrate(
        migrator.add_column("settings","capcha_text", capcha_text),
        migrator.add_column("settings", "capcha_time", capcha_time),
        migrator.add_column("settings", "capcha_btn_text", capcha_btn_text))
